...
public class HallManagementSystem {
    ...
    private static int authenticateUser() {
        ...
        while (attempts < 3) {
            ...
            if (email.equals(ADMIN_EMAIL) && password.equals(ADMIN_PASSWORD)) {
                ...
                System.out.println("CEO login successful!");
                return 2;
            } else {
                attempts++;
    ...
    private static void ceoMenu() {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 6 -> System.out.println("Exiting CEO Mode...");
                default -> System.out.println("Invalid choice!");
            }
        } while (choice != 6);
    }
    ...
    private static void addStudent() {
        ...
        if (!roomChoice.isEmpty()) {
            if (isRoomAvailable(roomChoice)) {
                ...
                System.out.println("Room not available. Auto-assigning...");
        ...
        for (Student s : students) {
            if (s.id.equals(id)) {
                ...
                if (isRoomAvailable(roomNo)) {
                    ...
                    System.out.println("Room full. Added to waiting list.");
    ...
    private static void vacateRoom() {
        System.out.println("Enter student ID to vacate room: ");
        String id = sc.nextLine();
        for (Student s : students) {
            if (s.id.equals(id)) {
                if (s.room.equals("Not Allocated")) {
                    ...
                    if (ws.requestedRoom.equals(vacatedRoom)) {
                        for (Student st : students) {
                            if (st.id.equals(ws.id)) {
                                ...
                                System.out.println("Automatically allocated " + vacatedRoom + " to " + st.name);
    ...
    private static void showWaitingList() {
        ...
        for (WaitingStudent ws : waitingQueue) {
            System.out.println(ws.name + " (ID: " + ws.id + ") waiting for " + ws.requestedRoom);
        }
    }
    ...
    private static void generateReport() {
        try (PrintWriter pw = new PrintWriter("hall_report.txt")) {
            ...
            System.out.println("Report generated as hall_report.txt");
        } catch (Exception e) {
    ...
    private static void forceRoomChanges() {
        ...
        System.out.println(moved + " students moved.");
    }
    ...
    private static void printAvailableRooms() {
        ...
        for (Room r : rooms) {
            if (r.occupied < r.capacity) {
                System.out.println(r.roomNo + " - " + r.occupied + "/" + r.capacity + " occupied");
            }
        }
    }
    ...
    private static void printStudentDetails(Student s) {
        ...
        System.out.println("Blood Group: " + s.bloodGroup);
        System.out.println("Phone: " + s.phone);
        System.out.println("Email: " + s.email);
        System.out.println("Room: " + s.room);
    }
